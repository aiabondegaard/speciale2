...
class IngenSUKandidatClass(EconModelClass):
    def settings(self):
    ...
    def value_of_choice_s(self, cons, g, motivation, assets, credit,t):
        ...
        #dynamics of assets
        if ((credit>(par.bachelor)) and (g>0.001)) and (t<=par.t_ls): 
        ...
        for i in range(par.simN):
            ...
            for t in range(par.simT):
                ...
                if t<(par.simT-1):
                    ...
                    #Dynamics of A
                    if  ((sim.G[i,t]>(par.bachelor)) and ((sim.g[i,t]>0.001)) and (t<=par.t_ls)): 
                    ...
                    elif (sim.g[i,t]>0.001) and (sim.G[i,t]<=par.bachelor):
