...
class SimpleBreakdownModelClass(EconModelClass):
    ...
    def setup(self):
        ...
        #income
        par.alpha = 3.0 #wage premium for high education
    ...
    def solve(self):
        ...
        #                     lb_g = 0.0000
        #                     ub_g = np.minimum(300,par.complete-credit+1.0e-5) #avoid dividing with 0 #fjern upper bound
